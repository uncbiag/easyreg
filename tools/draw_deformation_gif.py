...
def get_image_list_to_draw(refer_folder,img_type,t_list):
    ...
    source_path_list = [os.path.join(refer_folder, pair_name+img_type)  for pair_name in pair_name_list]
    target_path_list = [os.path.join(refer_folder,pair_name+"_test_iter_0_target.nii.gz")  for pair_name in pair_name_list]
    lsource_path_list = [os.path.join(refer_folder,pair_name+"_t_0d01_label.nii.gz")  for pair_name in pair_name_list]
...
img_type = "_t_0d01_image.nii.gz"
t_list = [0.01, 0.05,0.1, 0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6,0.65,0.7,0.75,0.8,0.85,0.9,0.95,1]
...
#output_folder= None
output_folder = "/playpen-raid1/zyshen/data/oai_reg/draw_oai_gif_gray_part2"
