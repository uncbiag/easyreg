...
#
# ################ Task 0   input -1 1#############
# tsm = ModelTask('task_261_vonet_ce_ch0')
# dm = DataTask('task_261_vonet_ce_ch0')
# dm.data_par['datapro']['task_type']='seg'
# dm.data_par['datapro']['dataset']['dataset_name']='brats'
# #dm.data_par['datapro']['dataset']['output_path']='/playpen/raid/zyshen/data/'
# # tsm.task_par['tsk_set']['save_fig_on'] = False
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'task_261_vonet_ce_ch0'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
# tsm.task_par['tsk_set']['epoch'] = 300
# tsm.task_par['tsk_set']['model'] = 'vonet'
# tsm.task_par['tsk_set']['batch_sz'] = 2
...
#
# ################ Task 0   input -1 1#############
# tsm = ModelTask('task_261_vonet_ce_ch01')
# dm = DataTask('task_261_vonet_ce_ch01')
# dm.data_par['datapro']['task_type']='seg'
# dm.data_par['datapro']['dataset']['dataset_name']='brats'
# #dm.data_par['datapro']['dataset']['output_path']='/playpen/raid/zyshen/data/'
# # tsm.task_par['tsk_set']['save_fig_on'] = False
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'task_261_vonet_ce_ch01'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
# tsm.task_par['tsk_set']['epoch'] = 300
# tsm.task_par['tsk_set']['model'] = 'vonet'
# tsm.task_par['tsk_set']['batch_sz'] = 2
...
# dm.data_par['datapro']['seg']['num_crop_per_class_per_train_img']=-1
# dm.data_par['datapro']['seg']['transform']['transform_seq']=['my_balanced_random_crop']
# dm.data_par['datapro']['seg']['transform']['my_bal_rand_crop']['scale_ratio']= 0.
#
#
# dm.data_par['datapro']['seg']['save_train_custom']=True
# dm.data_par['datapro']['seg']['num_flicker_per_train_img']=2
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'task_261_vonet_ce_th00'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
# tsm.task_par['tsk_set']['epoch'] = 300
# tsm.task_par['tsk_set']['model'] = 'vonet'
# tsm.task_par['tsk_set']['batch_sz'] = 2
...
#
# ################ Task 0   input -1 1#############
# tsm = ModelTask('task_261_vonet_ce_cr1_new')
# dm = DataTask('task_261_vonet_ce_cr1_new')
# dm.data_par['datapro']['task_type']='seg'
# dm.data_par['datapro']['dataset']['dataset_name']='brats'
# #dm.data_par['datapro']['dataset']['output_path']='/playpen/raid/zyshen/data/'
# # tsm.task_par['tsk_set']['save_fig_on'] = False
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'task_261_vonet_ce_cr1_new'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
# tsm.task_par['tsk_set']['epoch'] = 300
# tsm.task_par['tsk_set']['model'] = 'vonet'
# tsm.task_par['tsk_set']['batch_sz'] = 2
...
################ Task 0   input -1 1#############
tsm = ModelTask('task_261_vonet_wce_fixed_imd')
dm = DataTask('task_261_vonet_wce_fixed_imd')
dm.data_par['datapro']['task_type']='seg'
dm.data_par['datapro']['dataset']['dataset_name']='brats'
#dm.data_par['datapro']['dataset']['output_path']='/playpen/raid/zyshen/data/'
# tsm.task_par['tsk_set']['save_fig_on'] = False
...
tsm.task_par['tsk_set']['task_name'] = 'task_261_vonet_wce_fixed_imd'  #task42_unet4_base
tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
tsm.task_par['tsk_set']['epoch'] = 250
tsm.task_par['tsk_set']['model'] = 'vonet'
...
tsm.task_par['tsk_set']['voting']['start_saving_model'] = 200
tsm.task_par['tsk_set']['voting']['saving_voting_per_epoch'] = 2
tsm.task_par['tsk_set']['voting']['epoch_list'] = list(range(202,251,4))
...
# tsm.task_par['tsk_set']['gpu_ids'] = 0  #1
#
# tsm.task_par['tsk_set']['model_path'] = "/playpen/raid/zyshen/data/brats_com_full_ff_th01_brats_seg_nopatchedmy_balanced_random_crop/task_261_vonet_wce_momfix/checkpoints/epoch_180_"
# dm.data_par['datapro']['dataset']['task_name']='brats_com_full_ff_th01'
# dm.data_par['datapro']['dataset']['prepare_data']=False
# dm.data_par['datapro']['seg']['sched']='nopatched'
#
...
#
#
# tsm.task_par['tsk_set']['voting']['start_saving_model'] = 220
# tsm.task_par['tsk_set']['voting']['saving_voting_per_epoch'] = 2
#
#
# tsm.task_par['tsk_set']['criticUpdates'] = 2
...
#
# ################ Task 0   input -1 1#############
# tsm = ModelTask('task_261_vonet_wfl_customalse')
...
# tsm.task_par['tsk_set']['add_resampled']= dm.data_par['datapro']['seg']['add_resampled']
#
# tsm.task_par['tsk_set']['model_path'] = "/playpen/zyshen/data/brats_com_full_ff_th01_brats_seg_nopatchedmy_balanced_random_crop/task_261_vonet_wfl_custom/checkpoints/epoch_220_"
# dm.data_par['datapro']['dataset']['task_name']='brats_com_full_ff_th01'
# dm.data_par['datapro']['dataset']['prepare_data']=False
# dm.data_par['datapro']['seg']['sched']='nopatched'
#
...
# tsm.task_par['tsk_set']['voting']['start_saving_model'] = 200
# tsm.task_par['tsk_set']['voting']['saving_voting_per_epoch'] = 2
# tsm.task_par['tsk_set']['voting']['epoch_list'] = list(range(210,241,10))
#
# tsm.task_par['tsk_set']['criticUpdates'] = 2
# tsm.task_par['tsk_set']['max_batch_num_per_epoch'] = [400,4,1]
# tsm.task_par['tsk_set']['optim']['lr'] = 0.001/2
...
# tsm.task_par['tsk_set']['gpu_ids'] = 0  #1
#
# tsm.task_par['tsk_set']['model_path'] =""# "/playpen/raid/zyshen/data/brats_com_full_ff_th01_brats_seg_nopatchedmy_balanced_random_crop/task_261_vonet_t9_con_ce_custom/checkpoints/epoch_250_"
# dm.data_par['datapro']['dataset']['task_name']='brats_com_full_ff_th01'
# dm.data_par['datapro']['dataset']['prepare_data']=False
# dm.data_par['datapro']['seg']['sched']='nopatched'
#
...
# tsm.task_par['tsk_set']['epoch'] = 350
# tsm.task_par['tsk_set']['model'] = 'vonet'
# tsm.task_par['tsk_set']['batch_sz'] = 2
# tsm.task_par['tsk_set']['val_period'] =10
# tsm.task_par['tsk_set']['loss']['update_epoch'] =-1
...
# tsm.task_par['tsk_set']['voting']['start_saving_model'] = 200
# tsm.task_par['tsk_set']['voting']['saving_voting_per_epoch'] = 2
# tsm.task_par['tsk_set']['voting']['epoch_list'] =[250]
#
# tsm.task_par['tsk_set']['criticUpdates'] = 2
# tsm.task_par['tsk_set']['max_batch_num_per_epoch'] = [400,4,4]
# tsm.task_par['tsk_set']['optim']['lr'] = 0.001/2
# tsm.task_par['tsk_set']['optim']['lr_scheduler']['type'] = 'custom'
# tsm.task_par['tsk_set']['optim']['lr_scheduler']['custom']['step_size'] = 4000*5
# tsm.task_par['tsk_set']['optim']['lr_scheduler']['custom']['gamma'] = 0.5   # the learning r
#
# # ate should be ajusted in brats cases
#
#
# tsm.save()
# dm.save()
...
#
# ################ Task 0   input -1 1#############
# tsm = ModelTask('task_261_new_wce_bg_avg_fl')
# dm = DataTask('task_261_new_wce_bg_avg_fl')
# dm.data_par['datapro']['task_type']='seg'
# dm.data_par['datapro']['dataset']['dataset_name']='brats'
# #dm.data_par['datapro']['dataset']['output_path']='/playpen/raid/zyshen/data/'
# # tsm.task_par['tsk_set']['save_fig_on'] = False
...
# tsm.task_par['tsk_set']['add_resampled']= dm.data_par['datapro']['seg']['add_resampled']
#
# tsm.task_par['tsk_set']['model_path'] = ''# "/playpen/zyshen/data/brats_com_ff_th01_brats_seg_nopatchedmy_balanced_random_crop/task_261_new_wce_bg_avg_fl/checkpoints/epoch_120_"
# dm.data_par['datapro']['dataset']['task_name']='brats_com_full_ff_th01'
# dm.data_par['datapro']['dataset']['prepare_data']=False
# dm.data_par['datapro']['seg']['sched']='nopatched'
#
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'task_261_new_wce_bg_avg_fl'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
# tsm.task_par['tsk_set']['epoch'] = 300
# tsm.task_par['tsk_set']['model'] = 'vonet'
# tsm.task_par['tsk_set']['batch_sz'] = 2
...
#
# tsm.task_par['tsk_set']['voting']['start_saving_model'] = 200
# tsm.task_par['tsk_set']['voting']['saving_voting_per_epoch'] = 5
# tsm.task_par['tsk_set']['voting']['epoch_list'] =list(range(205,261,5))
#
#
#
# tsm.task_par['tsk_set']['criticUpdates'] = 2
...
#
# ################ Task 0   input -1 1#############
# tsm = ModelTask('task_261_new_ce_loc_samp')
# dm = DataTask('task_261_new_ce_loc_samp')
# dm.data_par['datapro']['task_type']='seg'
# dm.data_par['datapro']['dataset']['dataset_name']='brats'
# #dm.data_par['datapro']['dataset']['output_path']='/playpen/raid/zyshen/data/'
# # tsm.task_par['tsk_set']['save_fig_on'] = False
...
#
#
# tsm.task_par['tsk_set']['n_in_channel'] = 11  #1
# dm.data_par['datapro']['seg']['add_resampled']= True
# dm.data_par['datapro']['seg']['add_loc']= True
#
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'task_261_new_ce_loc_samp'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
# tsm.task_par['tsk_set']['epoch'] = 300
# tsm.task_par['tsk_set']['model'] = 'vonet'
# tsm.task_par['tsk_set']['batch_sz'] = 2
...
#
#
# tsm.task_par['tsk_set']['voting']['start_saving_model'] = 250
# tsm.task_par['tsk_set']['voting']['saving_voting_per_epoch'] = 5
# tsm.task_par['tsk_set']['voting']['epoch_list'] =[250]
#
#
...
# tsm.task_par['tsk_set']['model_epoch_list'] = [250]#list(range(100,250,20))
#
# dm.data_par['datapro']['dataset']['task_name']='brats_com_ff_th01'
# dm.data_par['datapro']['dataset']['prepare_data']=False
# dm.data_par['datapro']['seg']['sched']='nopatched'
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'tsk110_asm_partition_test'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='UNet3DB'
# tsm.task_par['tsk_set']['epoch'] = 250
