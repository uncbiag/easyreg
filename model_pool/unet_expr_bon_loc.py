...
class UNet3DB_loc(nn.Module):
    def __init__(self, in_channel, n_classes):
        self.in_channel = in_channel
        self.n_classes = n_classes
        super(UNet3DB_loc, self).__init__()
        ...
        self.dc2 = self.decoder(64 + 128+3, 128, kernel_size=3, stride=1, padding=1, bias=True,batchnorm=True)
    ...
    def forward(self, x):
        ...
        d3 = torch.cat((self.dc3(d4), syn0,x[:,-3:]), dim=1)
        del d4, syn0
