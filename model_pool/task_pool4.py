...
#tsm.task_par['tsk_set']['input_resize_factor'] =[1.,1.,1.]  #############################TODO ####################
...
tsm.task_par['tsk_set']['task_name'] = 'task_262_vonet_3'   # run in debug
tsm.task_par['tsk_set']['network_name'] ='UNet_asm_f'
tsm.task_par['tsk_set']['epoch'] = 150  # 360
...
# tsm.task_par['tsk_set']['gpu_ids'] = 1  #1
#
# tsm.task_par['tsk_set']['model_path'] = "/playpen/zyshen/data/lpba_2_vonet_lpba_seg_nopatchedmy_balanced_random_crop/debug_5_ada_org_sz/checkpoints/epoch_40_"
# dm.data_par['datapro']['dataset']['task_name']='lpba_2_vonet'
# dm.data_par['datapro']['dataset']['prepare_data']=False
# dm.data_par['datapro']['seg']['sched']='nopatched'
#
...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] = 'debug_5_ada_org_sz'  #task42_unet4_base
...
# #tsm.task_par['tsk_set']['gbnet_model_e'] =0
...
# tsm.task_par['tsk_set']['max_batch_num_per_epoch'] = [300,4,debug_num]
# tsm.task_par['tsk_set']['optim']['lr'] = 0.001/2
# tsm.task_par['tsk_set']['optim']['lr_scheduler']['type'] = 'custom'
