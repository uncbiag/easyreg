...
class UNet3D4B(nn.Module):
    def __init__(self, in_channel, n_classes):
        self.in_channel = in_channel
        self.n_classes = n_classes
        super(UNet3D4B, self).__init__()
        ...
        self.dc3 = self.decoder(128, 64, kernel_size=2, stride=2, bias=True, batchnorm=True)
        self.dc2 = self.decoder(64, 128, kernel_size=3, stride=1, padding=1, bias=True, batchnorm=True)
