...
class UNet3DB9(nn.Module):
    def __init__(self, in_channel, n_classes):
        self.in_channel = in_channel
        self.n_classes = n_classes
        super(UNet3DB9, self).__init__()
        ...
        self.dc8 = self.encoder(128, 128, kernel_size=3, stride=1, padding=1, bias=True, batchnorm=True)
        ...
        self.dc5 = self.encoder(128, 128, kernel_size=3, stride=1, padding=1, bias=True, batchnorm=True)
        ...
        self.dc2_pu = self.decoder(64, 128, kernel_size=1, stride=1, padding=0, bias=True, batchnorm=True)
