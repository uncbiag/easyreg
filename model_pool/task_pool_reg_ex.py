...
for sess in ['intra','inter']:
    ...
    tsm.task_par['tsk_set']['task_name'] = 'run_niftyreg_bspline_interv10_jacobi' #'train_affine_symstep5_lncc_bi'#'run_baseline_svf_lncc_bilncc'  #'reg_mermaid_sigma2_ncc'  #task42_unet4_base
