...
#     dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
#     tsm.task_par['tsk_set']['task_name'] = 'run_baseline_svf_jacobi_more_iter_save_def_fixed' #'train_affine_symstep5_lncc_bi'#'run_baseline_svf_lncc_bilncc'  #'reg_mermaid_sigma2_ncc'  #task42_unet4_base
...
#         dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
#         tsm.task_par['tsk_set']['task_name'] = 'run_affine_net_sym_lncc_multi_step_record_jacobi_'+str(step) #'train_affine_symstep5_lncc_bi'#'run_baseline_svf_lncc_bilncc'  #'reg_mermaid_sigma2_ncc'  #task42_unet4_base
...
#         tsm.task_par['tsk_set']['num_af_cycle'] = step  #mermaid_iter reg_net  ants  nifty_reg
