...
tsm.task_par['tsk_set']['task_name'] =  'run_ants'#'run_baseline_svf_lncc_bilncc'  #'reg_mermaid_sigma2_ncc'  #task42_unet4_base
tsm.task_par['tsk_set']['network_name'] ='syn'  #'mermaid' 'svf' 'syn'
tsm.task_par['tsk_set']['epoch'] = 300 #300
tsm.task_par['tsk_set']['model'] = 'ants'  #mermaid_iter reg_net  ants
