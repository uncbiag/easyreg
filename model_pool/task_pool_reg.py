...
# dm.data_par['datapro']['seg']['partition']['flicker_range']=5
#
# tsm.task_par['tsk_set']['task_name'] =  'run_baseline_affine_lncc_bi'#'run_baseline_svf_lncc_bilncc'  #'reg_mermaid_sigma2_ncc'  #task42_unet4_base
# tsm.task_par['tsk_set']['network_name'] ='affine'  #'mermaid' 'svf' 'syn' affine
# tsm.task_par['tsk_set']['epoch'] = 300 #300
# tsm.task_par['tsk_set']['model'] = 'mermaid_iter'  #mermaid_iter reg_net  ants
# tsm.task_par['tsk_set']['batch_sz'] = 6
# tsm.task_par['tsk_set']['val_period'] =10
# tsm.task_par['tsk_set']['loss']['update_epoch'] =-1
# tsm.task_par['tsk_set']['loss']['imd_weighted_loss_on']= False
...
tsm.task_par['tsk_set']['task_name'] ='run_demons_bi' #'run_niftyreg_af_bspline_baseline_scaled_interv10'#'train_mermaid_net_resid_sym_ncc'  #'reg_mermaid_sigma2_ncc'  #task42_unet4_base
tsm.task_par['tsk_set']['network_name'] ='demons'#''bspline'  #'mermaid'
tsm.task_par['tsk_set']['epoch'] = 300 #600 #300          ############################################3
tsm.task_par['tsk_set']['model'] = 'demons'#'reg_net' # 'nifty_reg' ants demons
