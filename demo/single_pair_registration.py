...
img_list_txt_path = '/playpen/zyshen/data/reg_debug_labeled_oai_reg_inter/test/pair_path_list.txt'
...
output_path = '/playpen/zyshen/data/reg_debug_labeled_oai_reg_inter/drawing_jacobi_det_img'
