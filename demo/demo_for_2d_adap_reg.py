...
def demo():
    ...
    parser.add_argument('--expr_name', required=False, default='rdmm_400_this_is_sm004_100fix',
    ...
    if not llf:
        ...
        if mermaid_setting_path =='non_path':
            if model_name == 'lddmm_adapt_smoother_map':
                mermaid_setting_path = '../mermaid/demos/sample_generation/cur_settings_adpt_lddmm_for_synth2.json'
            elif model_name == 'lddmm_shooting_map':
                mermaid_setting_path = '../mermaid/demos/sample_generation/cur_settings_lddmm_for_synth.json'
            else:
                mermaid_setting_path = '../mermaid/demos/sample_generation/cur_settings_svf_for_synth.json'
