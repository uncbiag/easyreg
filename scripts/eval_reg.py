...
from easyreg.reg_data_utils import (generate_pair_name,
                                    loading_img_list_from_files,
                                    read_txt_into_list, write_list_into_txt)
...
def do_registration_eval(args, registration_pair_list, pair_name_list=None):
    ...
    if model_path is not None:
        ...
        tsm.task_par['tsk_set']['model_path'] = model_path    #if not tsm.task_par['tsk_set']['train']:
